package mx.com.rlr.seccion_06_fragments_lab.Adapters;
...
public class MailAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.email = (TextView) convertView.findViewById(R.id.textViewListSenderName);
        ...
        holder.email.setText(currentMail.getEmail().substring(0, 1));
        // Obtenemos el backround que es un drawable, y le cambiamos el color con el random color
        holder.email.getBackground().setColorFilter(Color.parseColor("#" + currentMail.getColor()), PorterDuff.Mode.SRC);
