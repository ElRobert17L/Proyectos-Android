...
public class NotificationsHandler extends ContextWrapper {
    ...
    private final String SUMMATY_GROUP_NAME = "GROUPING_NOTIFICATION";
    ...
    public void publishNotificationSummaryGroup(boolean isHighImportance) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            String channelId = (isHighImportance) ? CHANNEL_HIGH_ID : CHANNEL_HIGH_ID;
